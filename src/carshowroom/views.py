...
from .serializers import CarShowroomSerializer, CarShowroomPresenceSerializer, CarSellsSerializer, \
    CarBuyersSerializer, CarShowroomSalesSerializer
from .models import CarShowroom, CarShowroomPresence, CarSells, CarShowroomBuyers, CarShowroomSales
from .filters import CarShowroomFilter, CarShowroomPresenceFilter, CarShowroomBuyersFilter, CarShowroomSalesFilter
...
class CarShowroomPresenceViewSet(mixins.ListModelMixin,
    ...
    ordering_fields = ['showroom__name', 'create_time', 'update_time', 'car__model__model', 'amount', 'price']
...
class CarBuyersViewSet(mixins.ListModelMixin,
    ...
    ordering_fields = ['showroom__name', 'buyer__last_name', 'create_time', 'update_time', 'sum_amount']
...
class CarShowroomSalesViewSet(mixins.CreateModelMixin,
    ...
    ordering_fields = ['title', 'showroom__name', 'discount', 'create_time', 'update_time', 'date_start', 'date_end']
