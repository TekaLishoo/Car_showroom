...
class CarFilter(filters.FilterSet):
    ...
    brand = filters.CharFilter(field_name='model__brand__brand', lookup_expr='icontains')
    ...
    class Meta:
        model = Car
        fields = ['body_type', 'drive_type', 'transmission', 'color', 'is_abs', 'fuel',
                  'is_parking_sensors', 'is_climate_control', 'is_cruise_control',
                  'is_heated_seats', 'is_active']
